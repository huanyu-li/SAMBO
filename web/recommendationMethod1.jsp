<%-- 
    Document   : recommendationMethod1
    Created on : Jan 5, 2011, 8:00:59 PM
    Author     : Shahab

    Modified By : Rajaram 
    Modified on : Jun 29, 2012, 10:14:42 AM
--%>
...
<%@page import="se.liu.ida.sambo.Recommendation.RecommendationMethod1"%>
    ...
    <body>
        <%      
            ...
            {               
               ...
               AccessRecommendationDB storeINDB= new AccessRecommendationDB(RecommendationConstants.RECOMMENDATION_METHOD1);
                ...
                RecommendationMethod1 recommendation = new RecommendationMethod1
                        (settings.getURL(Constants.ONTOLOGY_1),
                        settings.getURL(Constants.ONTOLOGY_2), 
                        Commons.SEGMENT+"SubG/");
                ...
                for (int i=0; i<result.size(); i++ )
                {
                    ...
                    if(i == 0)
                    {
                        ...
                        recommendation.findReferenceAlignment(numOfSegmPairs);
                    }
                ...
                ArrayList<HashMap>_result= storeINDB.select(ontologies,RecommendationConstants.DISPLAY_PARAMS);
                    ...
                    if(_result.size() > 0)
                    {
                       ...
                       formStr += "<td> <strong>"+s+"</strong></td>";
                        ...
                        formStr += "<tr><td align='center' style='color:red'>Cannot find saved PRA based recommendations for the selected pair of ontolgoies! </td></tr>";
