...
<html>
    <head>
            ...
            function alignUsingPRA()
            {
                for(i=0; i < 3; i++)
                {
                   if(document.alignments.group[i].checked)
                    document.alignments.action = "http://"+ window.location.hostname + ":"+ window.location.port + "/SAMBO-WebApp-SB/pras_alignment.jsp?id="+ document.alignments.group[i].value;
                }
        ...
        <script type="text/javascript">
            ...
            {
                window.opener.location.href="http://"+ window.location.hostname + ":"+ window.location.port + "/SAMBO-WebApp-SB/LoadSession?sid=64";
                self.close();
            }
