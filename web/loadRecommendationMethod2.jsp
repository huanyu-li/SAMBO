<%-- 
    Document   : loadRecommendatioMethod2
...
<html>
    <head>
        ...
        <title>Saved Recommendations 2</title>
                ...
                ArrayList<HashMap>_result= storeINDB.select(ontologies,RecommendationConstants.DISPLAY_PARAMS);
                    ...
                    if(_result.size() > 0)
                    {
                       ...
                       formStr += "<td> <strong>"+s+"</strong></td>";
                        ...
                        formStr += "<tr><td align='center' style='color:red'>Cannot find saved recommendations 2 for the selected pair of ontolgoies! </td></tr>";
