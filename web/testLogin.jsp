<%-- 
    Document   : testLogin
    Created on : Jun 28, 2016, 1:31:41 PM
    Author     : huali50
--%>

<%@page import="java.util.Date"%>
<%@page import="java.text.DateFormat"%>
<%@page import="se.liu.ida.sambo.Merger.testMergerManager"%>
        ...
        if (request.getParameter("login") != null) {
            ...
            if (isValidUser(request.getParameter("email").trim(), request.getParameter("pwd").trim(), request)) //Go to Align and Merge
            {
                ...
                if (!exist) {
                    ...
                    out.println(FormHandler.testcreateFileUploadForm(Constants.UNK, Constants.UNK));
                }else{
                ...
                out.println(testloginForm("Invalid email address or/and password"));
...
//Register
            ...
            if (reg == null) {
                out.println(testloginForm("Thanks for your registration. <br><br> Please check your email for password."));
                request.removeAttribute("email");
            } else {
                out.println(testloginForm("Registartion failed. " + reg));
                request.removeAttribute("email");
            }
...
//In a session
            ...
            out.println(testloginForm("Please login || register first <br><br> For registering, please input an email address at User Account, and a password will be sent."));
