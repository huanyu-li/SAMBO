<%-- 
    Document   : loadRecommendatioMethod1
...
<html>
    <head>
        ...
        <title>Saved Recommendations 1</title>
        <script type="text/javascript">
            ...
            function redirectToMain()
            {
                ...
                var matchers_list = "";
                var weight_list = "";
                var totalstrategies = document.getElementById("hdnlength").
                    value;
                ...
                for(i=0;i< totalstrategies;i++)
                {
                    ...
                    {
                        var matchers = document.getElementById("matcher"+i).
                            value;
                        var weights = document.getElementById("weight"+i).
                            value;
                        var combination = document.getElementById
                        ("combination"+i).value;
                ...
                ArrayList<HashMap>_result= storeINDB.select(ontologies,RecommendationConstants.DISPLAY_PARAMS);
                    ...
                    if(_result.size() > 0)
                    {
                       ...
                       formStr += "<td> <strong>"+s+"</strong></td>";
                        ...
                        formStr += "<tr><td align='center' style='color:red'>Cannot find saved recommendations 1 for the selected pair of ontolgoies! </td></tr>";
