 ...
 * @version 1.0
 */
public class SinglePairComputation {
     ...
     */
    public double calculateSimilarityValue(int matcher, Pair conceptPair, 
    ...
    private void perform(int matcher, Matcher[] matcherList, double[] weight){
        ...
        //pretty name
        String concept1Name = ((MElement) pair.getObject1()).getPrettyName();
        String concept2Name = ((MElement) pair.getObject2()).getPrettyName();
        // Concept 1 synms. 
        String synm1;
        //concept ID
        String concept1ID = ((MElement) pair.getObject1()).getId();
        String concept2ID = ((MElement) pair.getObject2()).getId();            
        ...
        if (((MElement) pair.getObject1()).isMClass() &&
            ...
            for (Enumeration en1 = ((MClass) pair.getObject1()
                ...
                calculate(matcherList, values, synm1, concept2Name);
