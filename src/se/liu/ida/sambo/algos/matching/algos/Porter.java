...
public class Porter extends Matcher{
  ...
  public String stripAffixes( String str ) {
   ...
   public double getSimValue(String input1, String input2){
        ...
        while(st1.hasMoreTokens()){
            ...
            String wordOne = stripAffixes(st1.nextToken());  
            for(StringTokenizer st2 = new StringTokenizer(input2); st2.hasMoreTokens();) 
                 if(wordOne.equalsIgnoreCase(stripAffixes(st2.nextToken()))) 
                     commonWord ++;
            
        }
          
        return commonWord/Handler.max((new StringTokenizer(input1)).countTokens(),(new StringTokenizer(input2)).countTokens());
    }


    /** For testing, print the stemmed version of a word */
    public static void main(String[] args){
	Porter test = new Porter();
	//System.out.println(test.stripAffixes("inflammatory"));
        //System.out.println(test.stripAffixes("inflammation"));
       // System.out.println(test.getSimValue("Department of Defence", "Defence Ministry"));
