...
import parallelProgramingtry.SplitSimValueCalculationTask;
...
/**
 * <p>
 * Handles various event related to the similarity value computation and finding
 * mapping suggestions.
 * </p>
 *
 * @author Rajaram
 * @version 2.0
 */
public final class SimValueConstructor {
     ...
     */
    public SimValueConstructor(final String step, final OntManager ontMan) {
        ...
        for (Enumeration e1 = ontogy1Content.elements();
            ...
            for(Enumeration e2 = onto2Content.elements();
                ...
                if(((MElement)pair.getObject1()).getAlignElement() == null
                    ...
                    /**
                     * Getting sim value for the selected matcher.
                     */ 
                     ...
                     * but add its sim value to the final sim value, in case 
                     * if the final sim value is greater than 1 then make 
                     * it as 1.
                     */ 
    ...
    public Vector loadPairList() {
        ...
        while (itrXMLFile.hasNext()) {
            ...
            for (Enumeration e1 = ontogy1Content.elements();
                 ...
                 */                
                if(suggestions.contains(concept1.toString())) {
                    break;                        
                } 
            }
            ...
            for(Enumeration e2 = onto2Content.elements();
                ...
                if(suggestions.contains(concept2.toString())) {
                    break;                        
                }           
            }
            // Generating pairs.
...
//        }
    ...
    private void multiThreadPerform(int matcher, Matcher[] matcherList, 
        ...
        SplitSimValueCalculationTask par = new 
                SplitSimValueCalculationTask(ontManager,matcher,matcherList,
                weight);        
        par.runTask(4);
    ...
    private void singleThreadPerform(int matcher, Matcher[] matcherList, double[] weight) {
        ...
        for(Enumeration e1 = ontogy1Content.elements(); e1.hasMoreElements();) {
    ...
    public ArrayList<String> getAcceptedPairs() {
        ...
        for(Enumeration e1 = ontogy1Content.elements(); e1.hasMoreElements();) {
            concept1 = e1.nextElement();
            conceptID1=((MElement)concept1).getId();
            
            for(Enumeration e2 = onto2Content.elements();
                    e2.hasMoreElements();) {
                concept2 = e2.nextElement();
                conceptID2=((MElement)concept2).getId();
                    
                conceptPair=conceptID1+AlgoConstants.SEPERATOR+conceptID2;        
                if (RecommendationConstants.ACCEPTED_SUGGESTIONS.
                        contains(conceptPair)) {
                    alignment.add(conceptID1+" == "+conceptID2);                        
                }              
            }
        }
    ...
    public ArrayList<String> getPRARejection() {
        ...
        for(Enumeration e1 = ontogy1Content.elements(); e1.hasMoreElements();) {
            c1 = e1.nextElement();
            ID1=((MElement)c1).getId();
            
            for(Enumeration e2 = onto2Content.elements();
                    e2.hasMoreElements();) {
                c2 = e2.nextElement();
                ID2 =((MElement)c2).getId();                    
