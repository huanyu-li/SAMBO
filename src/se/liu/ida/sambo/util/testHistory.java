...
public class testHistory {
   ...
   /**
     * Constructor 
     */
    public testHistory(testPair p, String name, int num, int action) {
        pair = p;
        this.name = name;
        this.num = num;
        this.action = action;
     ...
     * Constructor 
     */
    public testHistory(testPair p, String name, int num, int action, String comment) {
        pair = p;
        this.name = name;
        this.num = num;
        this.action = action;
   ...
   /**
     ...
     *@param p the pair
     */
    public void setPair(testPair p) {
	pair = p;
    }
