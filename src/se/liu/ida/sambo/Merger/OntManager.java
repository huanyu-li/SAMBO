...
public class OntManager {
     ...
     */
    public static MOntology loadOntology(String url, boolean inf){
    ...
    public static MOntology loadOntology(URL url, boolean inf){
        ...
        else ontModel = ModelFactory.createOntologyModel( OntModelSpec.OWL_MEM, null );
        
        ontModel.read(url.toString());
        
        if(inf)
            return new MOntology(ontModel);
        else return new MOntology(10, ontModel);
     ...
     *@return the MOntology of the ontology
     */
    public void loadOntology(String url, int num){
     ...
     *@return the MOntology of the ontology
     */
    public void loadOntology(URL url, int num){
