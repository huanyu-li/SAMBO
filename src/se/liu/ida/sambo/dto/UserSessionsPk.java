...
/** 
 * This class represents the primary key of the usersessions table.
 */
public class UserSessionsPk implements Serializable
{
	...
	/**
	 * Method 'UserSessionsPk'
	 * 
	 */
	public UserSessionsPk()
	{
	}
	 ...
	 * @param id
	 */
	public UserSessionsPk(final int id)
	{
		this.id = id;
	}
	...
	public boolean equals(Object _other)
	{
		...
		if (!(_other instanceof UserSessionsPk)) {
			return false;
		}
		
		final UserSessionsPk _cast = (UserSessionsPk) _other;
		if (id != _cast.id) {
			return false;
		}
	...
	public String toString()
	{
		...
		ret.append( "se.liu.ida.sambo.dto.UserSessionsPk: " );
		ret.append( "id=" + id );
		return ret.toString();
	}
